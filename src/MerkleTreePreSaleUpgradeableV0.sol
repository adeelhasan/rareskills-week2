...
contract MerkleTreePreSaleUpgradeableV0 is ERC721Upgradeable, OwnableUpgradeable, IERC2981Upgradeable {
    ...
    function initialize(bytes32 root) external initializer {
        __ERC721_init("MerklePresaleNFT", "MPSNFT");
        __Ownable_init();
        _root = root;
    }
    ...
    /// @notice reduce if burning the token
