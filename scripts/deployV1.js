(async () => {
    try {
        ...
        const v1Factory = await ethers.getContractFactory("MerkleTreePreSaleUpgradeableV1");
        const upgradedInstance = await upgrades.upgradeProxy(proxyAddress, v1Factory);
